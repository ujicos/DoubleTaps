...
namespace component
{
	...
	{
		pm_is_ads_allowed_hook = new utils::hook::detour(0x2FE9C, reinterpret_cast<void*>(pm_is_ads_allowed_stub));
		pm_weapon_process_hand_hook = new utils::hook::detour(0x38CF4, reinterpret_cast<void*>(pm_weapon_process_hand_stub));
		pm_weapon_fire_weapon_hook = new utils::hook::detour(0x382E8, reinterpret_cast<void*>(pm_weapon_fire_weapon_stub));
	}
